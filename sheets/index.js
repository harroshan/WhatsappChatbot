...
const getKeys = ssmStore.getParametersSync(
  [
    '/jobscheduler/privateKey',
    '/jobscheduler/clientEmail',
    '/jobscheduler/sheetId'
  ], {
    region: 'us-west-2'
  }
);
...
getApplicationStatus = (code, index) => {
  return gsService((info, resolve, reject) => {
...
module.exports = {
	getJobs,storeRecord,getApplicationStatus
}